package com.mmm.imagedownload.widget;
...
public class ShowImagesDialog extends Dialog {
    ...
    private ImageView mIvDialogDownload;
    ...
    private void initView() {
        ...
        mIvDialogDownload = mView.findViewById(R.id.iv_dialog_download);
    ...
    private void initData() {
        ...
        mIndexText.setText(mPositon + 1 + "/" + mImgUrls.size());
        ...
        mIvDialogDownload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               ImageDownloadManager.DownloadOneImage(mImgUrls.get(mPositon));
            }
        });
    }
